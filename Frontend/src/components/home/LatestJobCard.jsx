...
function LatestJobCard({job}) {
  ...
  return (
    <div className="p-5 rounded-md shadow-xl  bg-white border border-gray-100 cursor-pointer " onClick={()=>{navigate('/job/company/')}}>
      <div className="flex gap-3 my-2 items-center py-1 ">
        <div>
          <img  src={job?.company?.logo} className="h-10 w-10"/>
          {/* <Avatar> */}
      ...
      <div>
        ...
        <p className="text-sm text-gray-500">Work on Node.js and MongoDB.</p>
      </div>
