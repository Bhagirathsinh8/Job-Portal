...
import useGetCompanyById from "@/hooks/useGetCompanyById"; // ✅ import custom hook
...
function CompanySetup() {
  ...
  // ✅ Fetch company from backend & store to Redux
  ...
  // ✅ Update form input when company data arrives
  useEffect(() => {
    setInput({
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      const res = await axios.put(
        ROUTES.UPDATE_COMPANY(companyId),
        formData,
        {
          headers: {
    ...
    <div>
      ...
      <div className="max-w-xl mx-auto px-4 sm:px-6 lg:px-0 my-10">
        <form
          ...
          className="border border-gray-200 p-5 rounded-md shadow-sm"
        >
          {/* Header */}
